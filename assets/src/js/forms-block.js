...
const forms = window.im4wp_forms

registerBlockType('iys-panel-wp-form/form', {
  title: __('İYS Panel WP Form'),
  description: __('Block showing a İYS Panel WP sign-up form'),
  category: 'widgets',
  attributes: {
    id: {
      type: 'int'
  ...
  edit: function (props) {
    ...
    return (
      <div style={{ backgroundColor: '#f8f9f9', padding: '14px' }}>
        <SelectControl
          label={__('İYS Panel WP Sign-up Form')}
  ...
  save: function (props) {
    return null
    // return `[im4wp_form id="${props.attributes.id}"]`;
  }
})
