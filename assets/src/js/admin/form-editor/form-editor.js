...
let domDirty = false
let editor
const element = document.getElementById('im4wp-form-content')
const previewFrame = document.getElementById('im4wp-form-preview')
let previewDom
...
function setPreviewDom () {
  ...
  previewDom = frameContent.querySelector('.im4wp-form-fields')
...
function updatePreview () {
  ...
  previewDom.dispatchEvent(new Event('im4wp-refresh'))
}
