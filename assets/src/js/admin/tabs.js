...
const tabElements = context.querySelectorAll('.im4wp-tab')
...
function open (tab, updateState) {
  ...
  [].forEach.call(tabElements, t => {
    t.className = t.className.replace('im4wp-tab-active', '')
  ...
  tab.element.className += ' im4wp-tab-active'
  ...
  if (window.im4wp && window.im4wp.forms && window.im4wp.forms.editor) {
    window.im4wp.forms.editor.refresh()
  }
