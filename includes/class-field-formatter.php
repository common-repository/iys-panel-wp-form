...
/**
 * Class IM4WP_Field_Formatter
 *
 * Formats values based on what the İYS Panel API expects or accepts for the given field types.
 */
class IM4WP_Field_Formatter {
	...
	public function birthday( $value, $options = null ) {
		...
		// İYS Panel expects a MM/DD format, regardless of their display preference
	...
	public function date( $value, $options = null ) {
		...
		// İYS Panel expects a Y-m-d format no matter the display preference
