...
/**
 * Class IM4WP_API_Exception
 *
 * @property string $title
 * @property string $detail
 * @property array $errors
 */
class IM4WP_API_Exception extends Exception {
	...
	*/
	...
	/**
	 * IM4WP_API_Exception constructor.
	 *
	...
	*/
	...
	public function __toString() {
		...
		// add errors from response data returned by İYS Panel
